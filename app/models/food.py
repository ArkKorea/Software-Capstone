...
class Food(Base):
    ...
    bundles: Mapped[List['FoodBundle']] = relationship(
        "FoodBundle",
        secondary="food_bundle_items",
        back_populates="items",
        overlaps="items,food_bundle_items,bundle"
    )
    ...
    food_bundle_items: Mapped[List['FoodBundleItem']] = relationship(
        'FoodBundleItem',
        back_populates='food',
        overlaps="bundles,items,bundle"
    )
