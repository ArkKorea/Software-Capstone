...
from app.services.favorite_service import toggle_favorite, get_favorite_items, get_favorite_suppliers
from app.schemas.favorite import (
    FavoriteActionRequest,
)
from app.schemas.search import SearchProductResponse, SearchStoreResponse
...
@router.get("/favorites/suppliers", response_model=SearchStoreResponse)
def get_my_favorite_suppliers(
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user)
):
    return get_favorite_suppliers(db, current_user)
