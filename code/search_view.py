                    ...
                    controls=[
                        ...
                        ft.Row(
                            ...
                            controls=[
                                ...
                                ft.Icon(name="star_border", color=ft.Colors.GREY_600)
                            ]
                        ),
    ...
    def create_store_card(store):
        return ft.Container(
            ...
            content=ft.Row(
                ...
                controls=[
                    ft.Image(
                        src="https://raw.githubusercontent.com/ArkKorea/Software-Capstone/ui/image/product/store.png",  # ✅ 간단한 상점 아이콘
                        width=30,
                        height=30
                    ),
                    ft.Column(
        ...
        with httpx.Client(base_url=BASE_URL) as client:
            ...
            if response.status_code == 200:
                if category == "product":
                    ...
                    bundles = matched.get("bundles", [])

                    if products:
                        search_result.controls.append(ft.Text("상품 검색 결과", size=18, weight=ft.FontWeight.BOLD))
                        for p in products:
                    ...
                    if stores:
                        search_result.controls.append(ft.Text("지점 검색 결과", size=18, weight=ft.FontWeight.BOLD))
                        for s in stores:
                ...
                search_result.controls.append(
                    ft.Text("검색 중 오류가 발생했습니다.", size=16, color=ft.Colors.RED)
                )
        page.update()
